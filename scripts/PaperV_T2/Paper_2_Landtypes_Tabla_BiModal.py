...
for MAPA in MAPAS:
    ...
    for Band in Bands:
        ...
        for n_img in range(tot_img_samples):
            ...
            Tb_random = np.random.normal(0,10,n_cells)
            ...
            for Obs_std in Obs_errors:
               ...
               for mix_ratio in mix_ratios:
                 ...
                 if export_real and Obs_std == Obs_errors[0]:
                     Sol = [Tb, Tb]
                     L_Output.Export_Solution(Sol, Context, Band, 'Real_'+str(km)+'_'+Band+'_'+Method+str(n_img)+'_'+str(n_obs)+'_'+str(Obs_std).replace('.','_')  +str(mix_ratio).replace('.','_') )                     
